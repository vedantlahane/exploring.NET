...
1. If SellingAmount > PurchaseAmount: ProfitOrLossStatus = PROFIT; ProfitOrLossAmount = SellingAmount - PurchaseAmount
2. If SellingAmount < PurchaseAmount: ProfitOrLossStatus = LOSS; ProfitOrLossAmount = PurchaseAmount - SellingAmount
3. If SellingAmount == PurchaseAmount: ProfitOrLossStatus = BREAK-EVEN; ProfitOrLossAmount = 0
4. ProfitMarginPercent = (ProfitOrLossAmount / PurchaseAmount) * 100
5. Round displayed monetary values and percentage values to 2 decimal places
